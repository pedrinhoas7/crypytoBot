...
export class GraphicOperationService extends React.Component {
    ...
    async getGraphicOperation() {
        try {
            const res = await api.get(`/GraphicOperation`);
...
export default new GraphicOperationService();